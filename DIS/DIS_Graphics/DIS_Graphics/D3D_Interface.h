#ifndef D3D_INTERFACE_H
#define D3D_INTERFACE_H

#include "DIS_RenderStates.h"
#include "DIS_ResourceTypes.h"
#include "DIS_Device.h"

class D3D_DeviceInterface;

class IState
{
public:

	IState( D3D_DeviceInterface* pDevice )
	{
		m_pDevice = pDevice;
	}

	D3D_DeviceInterface *m_pDevice;

};


class IRenderStateSetter : public IState
{
public:
	IRenderStateSetter ( D3D_DeviceInterface* pDevice ) : IState( pDevice )
	{
	}

	virtual DIS_RESULT SetState( UInt32 A, UInt32 B) = 0;
	virtual DIS_RESULT GetState( UInt32 A, UInt32 *B) = 0;

};

class D3D_DeviceInterface 

#ifdef DERIVE_DEVICES
	: public DIS_Device
#endif
...
private:
	...
	IRenderStateSetter* m_RenderStateSetter[210];
...
*/
	...
	Int32 DIS_FogMode[4];
	Int32 DIS_Format[200];
	Int32 DIS_LightType[7];
	...
	Int32 BackBufferType;
	Int32 BasicSubdivType;
	Int32 BlendMode;
	Int32 BlendOp;
	Int32 CompareFunc;
	Int32 ComposeRectsOp;
	Int32 CubeMapFace;
	Int32 CullMode;
	Int32 DebugMonitor;
	Int32 DeclMethod;
	Int32 SubdivDegreeType;
	Int32 DeviceType;
	Int32 CompositorDisplayRotation;
	Int32 FillMode;
	Int32 FogMode;
	Int32 MultiSampleType;
	Int32 PatchEdgeStyle;
	...
	Int32 SampleTextureType;
	Int32 ScanlineOrdering;
	Int32 ShadeMode;
	Int32 SwapEffect;
